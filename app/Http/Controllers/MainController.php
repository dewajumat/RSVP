...
class MainController extends Controller
{
    ...
    {
        // $img_kk = $request->file('kk')->getClientOriginalName();
        // $request->file('kk')->storeAs('/KK', $img_kk);
        // $kk = $img_kk;
        ...
        //image Function
        $img_kk = $request->file('kk')->getClientOriginalName();
        $request->file('kk')->storeAs('/public/storage/KK', $img_kk);
        $img_ktp = $request->file('ktp')->getClientOriginalName();
        $request->file('ktp')->storeAs('/public/storage/KTP', $img_ktp);

        $req_data['kk'] =(string)$img_kk;
        $req_data['ktp'] =(string)$img_ktp;

        Penghuni::create($req_data);

...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md shadow-sm" id="green">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/vkontrakan/landpage') }}" style="color: white">
                    <strong>Rumah Sewa Villa Pertiwi</strong>
                </a>
